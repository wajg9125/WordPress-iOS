...
def wordpress_kit
    ...
    pod 'WordPressKit', :git => 'https://github.com/wordpress-mobile/WordPressKit-iOS.git', :branch => 'upgrade/xcode-to-12.0'
...
target 'WordPress' do
    ...
    ## =====================
    ##
    gutenberg :commit => '93db884b5563c8df0b47aae3365a9b3263a799ca'
